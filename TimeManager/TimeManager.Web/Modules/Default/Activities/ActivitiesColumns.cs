...
namespace TimeManager.Default.Columns
{
    ...
    public class ActivitiesColumns
    {
        ...
        [QuickFilter(true, CssClass = "hidden-xs"), LookupEditor(typeof(EmployeesRow)), QuickFilterOption("multiple", true)]
        public String EmployeeDescription { get; set; }
        [QuickFilter, LookupEditor(typeof(CustomersRow)), QuickFilterOption("multiple", true)]
        public String CustomerDescription { get; set; }
        [QuickFilter(true, CssClass = "hidden-xs"), LookupEditor(typeof(TagsRow)), QuickFilterOption("multiple", true)]
