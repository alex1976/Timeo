...
namespace TimeManager.Default.Entities
{
    ...
    public sealed class ActivitiesRow : Row, IIdRow, INameRow
    {
        ...
        [DateTimeKind(DateTimeKind.Unspecified), DateEditor]
        ...
        [DisplayName("Tag"), ForeignKey("[dbo].[Tags]", "TagId"), LeftJoin("jTag"), TextualField("TagId")]
        ...
        [DisplayName("Tag Description"), Expression("jTag.[Description]")]
