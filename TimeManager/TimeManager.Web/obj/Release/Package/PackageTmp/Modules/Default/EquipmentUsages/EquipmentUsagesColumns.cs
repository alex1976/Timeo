...
namespace TimeManager.Default.Columns
{
    ...
    public class EquipmentUsagesColumns
    {
        ...
        [EditLink, Width(200), QuickFilter(CssClass = "hidden-xs"), LookupEditor(typeof(EquipmentsRow))]
        public String EquipmentDescription { get; set; }
        [Width(200), QuickFilter, LookupEditor(typeof(CustomersRow))]
        public String CustomerDescription { get; set; }
        [Width(200), QuickFilter(CssClass = "hidden-xs"), LookupEditor(typeof(ActivitiesRow))]
